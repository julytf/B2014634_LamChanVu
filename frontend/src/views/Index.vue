<template>
  <div>
    <index-navbar />
    <section class="header relative pt-16 items-center flex h-96 max-h-860-px">
      <div class="container mx-auto items-center flex flex-wrap">
        <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
          <div class="pt-32 sm:pt-0">
            ...
            <div class="mt-2">
              <input type="text" name="first-name" id="first-name" autocomplete="given-name" placeholder="Tên sách"
                v-model="searchText"
                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            </div>
            <div class="mt-4">
              <button @click="searchBookHandler()"
        ...
        <div class="justify-center flex flex-wrap">
          <div class="w-full lg:w-12/12 px-4 mt-6 pb-16">
            <div class="flex flex-wrap">
              ...
              <div v-for="book in books" :key="book._id" class="w-full lg:w-4/12 px-4">
                <h5 class="text-xl font-semibold pb-4 text-center text-white h-16">
                  {{ book.name }}
                </h5>
                <h6 class="text-md font-semibold pb-4 text-center text-yellow-500 h-8">
                  {{ book.price }} vnđ
                </h6>
                <router-link to="/auth/login">
                  <div
                    ...
                    <button class="w-8 absolute right-0 m-4 hover:scale-110" @click.prevent="addBookToCart(book._id)">
                      <img src="cart-icon.png" class="w-full">
                    </button>
                    <img alt="..." class="align-middle border-none max-w-full h-auto rounded-lg" :src="book.image" />
                  </div>
                </router-link>
              </div>
